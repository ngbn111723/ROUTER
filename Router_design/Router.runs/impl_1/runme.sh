...
HD_PWD='C:/Users/LENOVO/Desktop/CE433/Practice/LAB02/Router/Router.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Router.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Router.tcl -notrace
