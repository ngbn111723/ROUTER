...
HD_PWD='C:/Users/LENOVO/Desktop/CE433/Practice/LAB02/Router/Router.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Router.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Router.tcl
